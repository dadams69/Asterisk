...
class Fieldset_Related_Content extends CI_Controller {
    public function __construct() {
        parent::__construct();
        $this->load->model("related_content_model", "model");
    }
    ...
    public function form($fieldset_id){
        ...
        if ($form) {
            ...
            if ($work_area_data["validation"]["error"]) {
                ...
                $data["message"]["text"] = "Related Content saved.";
    ...
    public function find_content(){
        ...
        $existing_content_id = $this->input->get("existing_content_id");
        $content = $this->model->get_content_by_query($term, $existing_content_id);
